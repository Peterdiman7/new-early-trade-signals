                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 big-column">
                        ...
                        <div class="footer-lower">
                            ...
                            <ul class="footer-card clearfix">
                                ...
                                <li><a href="#"><img src="/images/icons/card-1.png" alt=""></a></li>
                                <li><a href="#"><img src="/images/icons/card-2.png" alt=""></a></li>
                                <li><a href="#"><img src="/images/icons/card-3.png" alt=""></a></li>
                                <li><a href="#"><img src="/images/icons/card-4.png" alt=""></a></li>
                                <li><a href="#"><img src="/images/icons/card-5.png" alt=""></a></li>
                                <li><a href="#"><img src="/images/icons/card-6.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
